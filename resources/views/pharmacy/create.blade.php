        ...
        <div class="col-md-8" style="margin-left:150px">
            ...
            <!--departent starts here-->
                <div class="row mb-3">
                  ...
                  <select  autofocus name="officer_id"  class="form-control">
            ...
            <div class="row mb-3">
                ...
                <input type="text" name="pharmacy_name" class="form-control   @error('pharmacy_name') is-invalid @enderror" value="{{ old('pharmacy_name') }}" autofocus>
                @error('pharmacy_name')
                <span class="invalid-feedback" role="alert">
                    <strong>{{ $message }}</strong>
                </span>
    ...
    <!--name ends here-->
        ...
        <!--phone sarts here-->
            <div class="row mb-3">
                ...
                <input type="tel" name="phone_id"   id="phone_id" class="form-control   @error('phone_id') is-invalid @enderror" value="{{ old('phone_id') }}" autofocus>
                @error('phone_id')
                <span class="invalid-feedback" role="alert">
                    <strong>{{ $message }}</strong>
                </span>
