    ...
    <div class="row content-justify-center">
        <div class="col-md-8" style="margin-left:150px">
            ...
            <div class="card">
                ...
                <!--name starts here-->
                        <div class="row mb-3">
                            ...
                            <input type="text" name="name" class="form-control   @error('name') is-invalid @enderror" value="{{ $marketing->name }}" autofocus>
                            @error('name')
            ...
            <div class="row mb-3">
                ...
                <input type="tel" name="phone"   id="phone" class="form-control   @error('phone') is-invalid @enderror" value="{{ $marketing->phone }}" autofocus>
                @error('phone')
                <span class="invalid-feedback" role="alert">
                    <strong>{{ $message }}</strong>
                </span>
