    ...
    <div class="row content-justify-center">
        <div class="col-md-8" style="margin-left:150px">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form action="{{ route('bed.update',[$bed->id]) }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        {{ method_field('PUT') }}
                <!--room starts here-->
                        <div class="row mb-3">
                            <label for="room">Room No. <span style="color: red">*</span></label>
                            <input type="text" name="room" class="form-control   @error('room') is-invalid @enderror" value="{{ $bed->room }}" autofocus>
                            @error('room')
                ...
                <!--bed starts here-->
                        <div class="row mb-3">
                            ...
                            <input type="text" name="bed" class="form-control   @error('bed') is-invalid @enderror" value="{{ $bed->bed }}" autofocus>
                            @error('bed')
                            <span class="invalid-feedback" role="alert">
                                <strong>{{ $message }}</strong>
                            </span>
...
<!--floor ends here-->
    ...
    <div class="row mb-3">
        ...
        <input type="text" name="price" class="form-control   @error('price') is-invalid @enderror" value="{{ $bed->price }}" autofocus>
        @error('price')
        <span class="invalid-feedback" role="alert">
            <strong>{{ $message }}</strong>
        </span>
            ...
            <!--satus starts here -->
                    <div class="row mb-3">
                        ...
                        <div class="row mb-3">
                            ...
                            <input type="file" name="image" class="form-control   @error('image') is-invalid @enderror" value="{{ $bed->image }}">
                            @error('image')
                            <span class="invalid-feedback" role="alert">
                                <strong>{{ $message }}</strong>
                            </span>
