...
<div class="container">
    ...
    <div class="row mb-3">
        ...
        <input type="text" name="occupation"  class="form-control   @error('occupation') is-invalid @enderror" value="{{ old('occupation') }}" autofocus>
        @error('occupation')
        <span class="invalid-feedback" role="alert">
            <strong>{{ $message }}</strong>
        </span>
...
<!--patient  relative ends here-->
 ...
 <div class="row mb-3">
    ...
    <input type="text" name="rname"  class="form-control   @error('rname') is-invalid @enderror" value="{{ old('rname') }}" autofocus>
    @error('rname')
    <span class="invalid-feedback" role="alert">
        <strong>{{ $message }}</strong>
    </span>
...
<!--phone ends here-->
 ...
 <div class="row mb-3">
    ...
    <input type="tel" name="home-phone"   id="home-phone" class="form-control   @error('home-phone') is-invalid @enderror" value="{{ old('home-phone') }}" autofocus>
    @error('home-phone')
    <span class="invalid-feedback" role="alert">
        <strong>{{ $message }}</strong>
    </span>
 ...
 <div class="row mb-3">
  ...
  <select name="bed"  class="form-control  @error('bed') is-invalid @enderror">
    ...
    @foreach (App\Models\Bed::all() as $bed )
       <option value="{{ $bed->id }}">BD-{{ $bed->bed }}</option>
@endforeach
  </select>
    @error('bed')
    <span class="invalid-feedback" role="alert">
...
<!--patient bed ends here-->
            ...
            <!--symptoms starts here-->
                        <div class=" row mb-2">
                            ...
                            <textarea name="symptoms" id="editor" class="form-control   @error('symptoms') is-invalid @enderror"    autofocus>{{ old('symptoms') }}</textarea>
                            <script>
                                ClassicEditor
