    ...
    <div class="row content-justify-center">
        <div class="col-md-8" style="margin-left:150px">
            ...
            <div class="card">
                ...
                <!--name starts here-->
                        <div class="row mb-3">
                            ...
                            <input type="text" name="name" class="form-control   @error('name') is-invalid @enderror" value="{{ $doctor->name }}" autofocus>
                            @error('name')
                ...
                <!--username starts here-->
                        <div class="row mb-3">
                            ...
                            <input type="text" name="username"  class="form-control   @error('username') is-invalid @enderror" value="{{ $doctor->username }}" autofocus>
                            @error('username')
                            <span class="invalid-feedback" role="alert">
                                <strong>{{ $message }}</strong>
                            </span>
                ...
                <div class="row mb-3">
                        ...
                        <input type="date" name="dob"  class="form-control   @error('dob') is-invalid @enderror" value="{{ $doctor->dob }}" autofocus>
                        @error('dob')
                        <span class="invalid-feedback" role="alert">
                            <strong>{{ $message }}</strong>
                        </span>
            ...
            <!--address-starts-->
                  <div class="row mb-3">
                    ...
                    <input type="text" name="address"  class="form-control   @error('address') is-invalid @enderror" value="{{ $doctor->address}}" autofocus>
                    @error('address')
                    <span class="invalid-feedback" role="alert">
                        <strong>{{ $message }}</strong>
                    </span>
        ...
        <!--phone sarts here-->
            <div class="row mb-3">
                ...
                <input type="tel" name="phone"   id="phone" class="form-control   @error('phone') is-invalid @enderror" value="{{ $doctor->phone }}" autofocus>
                @error('phone')
                <span class="invalid-feedback" role="alert">
                    <strong>{{ $message }}</strong>
                </span>
        ...
        <!--phone ends here-->
            ...
            <!--biography starts here-->
                        <div class=" row mb-2">
                            ...
                            <textarea name="biography" id="editor" class="form-control   @error('biography') is-invalid @enderror"   autofocus>{!! $doctor->biography !!}</textarea>
                            <script>
                                ClassicEditor
            ...
            <!--image upload starts here-->
                        <div class="row mb-3">
                            ...
                            <input type="file" name="image" class="form-control   @error('image') is-invalid @enderror" value="{{ $doctor->image }}">
                            @error('image')
                            <span class="invalid-feedback" role="alert">
                                <strong>{{ $message }}</strong>
                            </span>
