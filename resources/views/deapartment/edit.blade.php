        ...
        <div class="col-md-8" style="margin-left:150px">
            ...
            <div class="card">
                ...
                <!--name starts here-->
                        <div class="row mb-3">
                            ...
                            <input type="text" name="name" class="form-control   @error('name') is-invalid @enderror" value="{{ $department->name}}" autofocus>
                            @error('name')
            ...
            <!--description starts here-->
                        <div class=" row mb-2">
                            ...
                            <textarea name="description" id="editor" class="form-control   @error('description') is-invalid @enderror" placeholder="Write News Here..."   autofocus>{{ $department->description}}</textarea>
                            <script>
                                ClassicEditor
